...
CUDA_VISIBLE_DEVICES=0 PYTHONHASHSEED=0 python "${project_dir}/src/main.py" \
        ...
        --test_dataset_name="${project_dir}/numerical_datasets/data/depth_${depth}_distractor_3/test_NL_step_by_step_exhaustive.jsonl" \
        --model_name=bart \
        ...
        --train_epochs=1 \
        --eval_steps=100  \
        --output_dir="${save_model_dir}/reasoning_model/42/depth_${depth}_distractor_3_by_depth_1_5_distractor_3/bart_large/NL_step_by_step_exhaustive" \
        --run_dir="42/depth_${depth}_distractor_3_by_depth_1_5_distractor_3/bart_large/NL_step_by_step_exhaustive" \
        --batch_size=8 \
