...
CUDA_VISIBLE_DEVICES=0 PYTHONHASHSEED=0 python "${project_dir}/src/main.py" \
        ...
        --eval_steps=1000  \
        --save_steps=5000 \
        --output_dir="${save_model_dir}/reasoning_model/42/depth_1_5_distractor_3/NL_no_reasoning_step_caliculum" \
        --run_dir="42/depth_1_5_distractor_3/NL_no_reasoning_step_caliculum" \
        --batch_size=16 \
