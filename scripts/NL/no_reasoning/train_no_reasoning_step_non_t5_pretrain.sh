...
CUDA_VISIBLE_DEVICES=0 PYTHONHASHSEED=0 python "${project_dir}/src/main.py" \
        ...
        --test_dataset_name="${project_dir}/numerical_datasets/data/depth_1_5_distractor_3/test_NL_no_reasoning_step.jsonl" \
        --model_name=t5 \
        ...
        --eval_steps=1000  \
        --save_steps=5000 \
        --output_dir="${save_model_dir}/reasoning_model/42/depth_1_5_distractor_3/NL_no_reasoning_step_non_t5_pretrain" \
        --run_dir="42/depth_1_5_distractor_3/NL_no_reasoning_step_non_t5_pretrain" \
        --batch_size=16 \
