...
CUDA_VISIBLE_DEVICES=0 PYTHONHASHSEED=0 python "${project_dir}/src/main.py" \
        ...
        --test_dataset_name="${project_dir}/numerical_datasets/data/depth_1_5_distractor_3/test_step_by_step_shortest.jsonl" \
        ...
        --eval_steps=10000  \
        --save_steps=10000 \
        --output_dir="${save_model_dir}/reasoning_model/42/depth_1_5_distractor_3/shape_bart/step_by_step_shortest" \
        --run_dir="42/depth_1_5_distractor_3/shape_bart/step_by_step_shortest" \
        --batch_size=8 \
